...
public class Vicky {
    ...
    private Texture vickyFaceLeft;
    private Texture vickyFaceRight;
    ...
    public Vicky(float x,float y)
    {
        ...
        actionCode=0;
        vickyFaceLeft=new Texture(Gdx.files.internal("Vicky/VickyFacingLeft.png"));
        vickyFaceRight=new Texture(Gdx.files.internal("Vicky/VickyFacingRight.png"));
    ...
    {
        batch.draw(vickyFaceLeft,getX(),getY());
    }

    public void drawRight(SpriteBatch batch)
    {
        batch.draw(vickyFaceRight,getX(),getY());
    }
